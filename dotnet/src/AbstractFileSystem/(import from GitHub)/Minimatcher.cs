...
// https://raw.githubusercontent.com/SLaks/Minimatch/master/Minimatch/Minimatcher.cs
// Project: https://github.com/SLaks/Minimatch(thanks to the autor!)
//</auto-generated>
//-----------------------------------------------------------------------
...
namespace Utils
{
    ...
    [CompilerGeneratedAttribute()][GeneratedCode( tool:"Mirrored file from GitHub", version:"30.01.2024")]
    ...
    [CompilerGeneratedAttribute()][GeneratedCode( tool:"Mirrored file from GitHub", version:"30.01.2024")]
    internal partial class Minimatcher
    {
        ...
        private partial class PatternListEntry
        {
        ...
        abstract partial class ParseItem
        {
        ...
        partial class LiteralItem : ParseItem
        {
        ...
        partial class MagicItem : ParseItem
        {
        ...
        partial class GlobStar : ParseItem
        {
            private GlobStar() { }
        ...
        private Tuple<ParseItem, bool> Parse(string pattern, bool isSub)
        {
            ...
            // handle the case where we left a partial class open.
            // "[abc" is valid, equivalent to "\[abc"
            if (inClass)
            {
                // split where the last [ was, and escape it
                // this is a huge pita.  We now have to re-walk
                // the contents of the would-be partial class to re-translate
