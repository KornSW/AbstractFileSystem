...
namespace SharpFtpServer
{
    ...
    {
        void Info(object newEnty);
        void Error(object newEnty);
    }

    public class MyLog : ILog
    {
        public void Info(object newEntry)
        {
            Console.WriteLine(newEntry.ToString());
        }

        public void Error(object newEntry)
        {
            Console.WriteLine(newEntry.ToString());
        }
    ...
    {
        public static ILog GetLogger(System.Type targetType)
        {
            return new MyLog();
        }
    }
